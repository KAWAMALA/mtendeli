...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [30.865778, -3.436654, 30.914027, -3.406848], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [30.873119, -3.435697, 30.905729, -3.407400],
            units: 'degrees'})
    })
});
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_MTENDELI2019DISSOLVED_0,
      colName: 'Percentage',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([30.865778, -3.436654, 30.914027, -3.406848], map.getSize());
